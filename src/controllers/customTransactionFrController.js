...
class CustomTransactionFrController extends BaseController {
  constructor(customerId, transaction) {
    super(db.CustomTransactionFr, customerId, { individualHooks: true, transaction });
  }
...
export default CustomTransactionFrController;
